    ...
    <div className="p-4 sm:ml-64 bg-gray-100 ">
        <div className="p-4 rounded-lg dark:border-gray-700 mt-20">
            ...
            <div className="grid grid-cols-4 gap-4 mb-4">
                <div className="relative flex flex-col min-w-0 break-words bg-gradient-to-r from-blue-200 to-cyan-300 rounded-lg mb-6 xl:mb-0 shadow-lg">
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-gradient-to-r from-purple-300 to-purple-200 rounded-lg mb-6 xl:mb-0 shadow-lg">
                    <div className="flex-auto p-4">
                        <div className="flex flex-wrap">
                            <div className="relative w-full pr-4 max-w-full flex-grow flex-1">
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-gradient-to-r from-pink-300 to-pink-200 rounded-lg mb-6 xl:mb-0 shadow-lg">
                    <div className="flex-auto p-4">
                        <div className="flex flex-wrap">
                            <div className="relative w-full pr-4 max-w-full flex-grow flex-1">
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
                ...
                <div className="grid grid-rows-3 grid-flow-col gap-4">
                    ...
                    <div className="col-span-2">
                        <div className=" flex flex-col min-w-0 break-words bg-gradient-to-r from-blue-200 to-cyan-300 rounded-lg mb-6 xl:mb-0 shadow-lg">
                            <div className="flex-auto p-4">
                                <div className="flex flex-wrap">
